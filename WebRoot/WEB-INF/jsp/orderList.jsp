...
<body>
		...
		<div class="span5">
			<div class="logo">
				<!-- <a href="./网上商城/index.htm">  --><img
					src="${pageContext.request.contextPath}/image/Lego.jpg"
					alt="乐购商城" /> <!-- </a> -->
			</div>
		</div>
		<div class="span9">
			...
			<table>
				<tbody>
					<s:iterator var="order" value="pageBean.list">
						<tr>
							<th colspan="5">订单编号:<s:property value="#order.oid" />&nbsp;&nbsp;&nbsp;&nbsp;订单金额:
							<font
	...
	<div class="container footer">
		...
		<div class="span24">
			<ul class="bottomNav">
				<li><a href="javascript:alert('功能尚未完成，敬请期待!');">关于我们</a> |</li>
				<li><a href="javascript:alert('功能尚未完成，敬请期待!');">联系我们</a> |</li>
				<li><a href="javascript:alert('功能尚未完成，敬请期待!');">诚聘英才</a> |</li>
				<li><a href="javascript:alert('功能尚未完成，敬请期待!');">法律声明</a> |</li>
				<li><a href="javascript:alert('功能尚未完成，敬请期待!');">友情链接</a> |</li>
				<li><a href="javascript:alert('功能尚未完成，敬请期待!');" target="_blank">支付方式</a> |</li>
				<li><a href="javascript:alert('功能尚未完成，敬请期待!');" target="_blank">配送方式</a> |</li>
				<li><a href="javascript:alert('功能尚未完成，敬请期待!');">SHOP++官网</a> |</li>
				<li><a href="javascript:alert('功能尚未完成，敬请期待!');">SHOP++论坛</a></li>
			</ul>
		</div>
		<div class="span24">
