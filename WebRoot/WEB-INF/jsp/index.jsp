	...
	<div class="span5">
		<div class="logo">
			<!-- <a href="./网上商城/index.htm"> -->
				<img src="${pageContext.request.contextPath}/image/Lego.jpg" alt="乐购商城"/>
			<!-- </a> -->
		</div>
	</div>
	<div class="span9">
		...
		<div class="span24">
			<div class="friendLink">
				<dl>
					<dt>新手指南</dt>
							<dd>
								<a href="javascript:alert('功能尚未完成，敬请期待!');" target="_blank">支付方式</a>
								|
							</dd>
							<dd>
								<a href="javascript:alert('功能尚未完成，敬请期待!');" target="_blank">配送方式</a>
								|
							</dd>
							<dd>
								<a href="javascript:alert('功能尚未完成，敬请期待!');" target="_blank">售后服务</a>
								|
							</dd>
							<dd>
								<a href="javascript:alert('功能尚未完成，敬请期待!');" target="_blank">购物帮助</a>
								|
							</dd>
							<dd>
								<a href="javascript:alert('功能尚未完成，敬请期待!');" target="_blank">网站地图</a>
								|
							</dd>
							<dd>
								<a href="javascript:alert('功能尚未完成，敬请期待!');" target="_blank">合作伙伴</a>
								|
							</dd>
							<dd>
								<a href="javascript:alert('功能尚未完成，敬请期待!');" target="_blank">蔬菜卡</a>
								|
							</dd>
							<dd>
								<a href="javascript:alert('功能尚未完成，敬请期待!');" target="_blank">礼品卡</a>
								|
							</dd>
							<dd>
								<a href="javascript:alert('功能尚未完成，敬请期待!');" target="_blank">银联卡</a>
								|
							</dd>
							<dd>
								<a href="javascript:alert('功能尚未完成，敬请期待!');" target="_blank">亿家卡</a>
								|
							</dd>
							<dd>
								<a href="javascript:alert('功能尚未完成，敬请期待!');" target="_blank">乐购</a>
							</dd>
					<dd class="more">
						<a href="javascript:alert('功能尚未完成，敬请期待!');" >更多</a>
					</dd>
				</dl>
			</div>
		</div>
...
<div class="container footer">
	...
	<div class="span24">
		<ul class="bottomNav">
					<li>
						<a href="javascript:alert('功能尚未完成，敬请期待!');">关于我们</a>
						|
					</li>
					<li>
						<a href="javascript:alert('功能尚未完成，敬请期待!');">联系我们</a>
						|
					</li>
					<li>
						<a href="javascript:alert('功能尚未完成，敬请期待!');">招贤纳士</a>
						|
					</li>
					<li>
						<a href="javascript:alert('功能尚未完成，敬请期待!');">法律声明</a>
						|
					</li>
					<li>
						<a href="javascript:alert('功能尚未完成，敬请期待!');">友情链接</a>
						|
					</li>
					<li>
						<a href="javascript:alert('功能尚未完成，敬请期待!');" target="_blank">支付方式</a>
					...
					<li>
						<a href="javascript:alert('功能尚未完成，敬请期待!');">服务声明</a>
						|
					</li>
					<li>
						<a href="javascript:alert('功能尚未完成，敬请期待!');">广告声明</a>
						
					</li>
		</ul>
	</div>
	<div class="span24">
		<div class="copyright">Copyright © 2016-2018 网上商城 版权所有</div>
	</div>
</div>
</body>
</html>