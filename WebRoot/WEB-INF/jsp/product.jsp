		...
		<div class="span18 last">
			...
			<div id="bar" class="bar">
				...
				<div id="introduction" name="introduction" class="introduction">
					...
					<div>
						<img width="375px" height="305px" src="${pageContext.request.contextPath }/<s:property value="model.image"/>">
					</div>
				</div>
		</div>
	</div>
<div class="container footer">
	...
	<div class="span24">
		<ul class="bottomNav">
					...
					<li>
						<a href="javascript:alert('功能尚未完成，敬请期待!');">诚聘英才</a>
						|
					</li>
					<li>
					...
					<li>
						<a href="javascript:alert('功能尚未完成，敬请期待!');">SHOP++官网</a>
						|
					</li>
					<li>
						<a href="javascript:alert('功能尚未完成，敬请期待!');">SHOP++论坛</a>
